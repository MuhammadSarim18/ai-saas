                ...
                <div>
                    <Form {...form}>
                        <form
                            ...
                            className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm gird grid-cols-12 gap-2">
                            <FormField
                                name="prompt"
                                render={({ field }) => (
                    ...
                    <div className="flex flex-col-reverse gap-y-4">
                        {messages.map((message) => (
                            <div
                                key={message.content}
                                className={cn(
                                    "p-8 w-full items-start gap-x-8 rounded-lg", message.role === "user" ? "bg-white border border-black/10" : "bg-muted"
                                )}
                            >
